...
[IMPORTANT]
====
**THIS REPO IS A FORK** of the amazing link:https://github.com/bkuhlmann/mac_os.git[bkuhlmann/mac_os] project,
with a few edits to suit my own Mac Setup purposes.  
